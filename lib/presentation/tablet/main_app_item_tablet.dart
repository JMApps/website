...
import 'package:website/presentation/tablet/app_screenshots_tablet.dart';
...
class MainAppItemTablet extends StatelessWidget {
  final MainAppModel item;

  const MainAppItemTablet({super.key, required this.item});
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            AppScreenshotsTablet(item: item),
            const SizedBox(height: 16),
            const QRLinks(),
          ],
        ),
